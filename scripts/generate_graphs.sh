...
TITLES=("Modelių rezultatai su sferos funkcijos generuotais duomenim" "Modelių rezultatai su Rosenbrock'o funkcijos generuotais duomenim" "Modelių rezultatai su Rastrigin'o funkcijos generuotais duomenim")
